...
void function_aloc_prioridade(int prio,int pid){
  //0 maior prioridade
  //5 baixa prioridade
  //10 muita baixa prioridade
  // apos reduzir não consigo aumentar prioridade
  setpriority(PRIO_PROCESS, pid, prio);
  cout << "\nprocesso com o PID: " << pid << ",foi alocado na seguinte prioridade: " << prio << "\n\n";
  cout << "valor da prioridade do processo: após segundo setpriority() " << getpriority(PRIO_PROCESS, pid ) <<endl;
};
...
int main()
{
  while(1){
    ...
    case 5:
      ...
      break;
    case 6:
      printf( "Digite qual a prioridade do processo: \n");
      cin >> prioridade;
      printf( "Digite qual PID do processo que você quer mudar prioridade: ");
      cin >> pid_vitima;
      function_aloc_prioridade(prioridade, pid_vitima);
      break;
