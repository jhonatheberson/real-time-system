...
class MyGame():
    ...
    def L1(self):
        if self.direction_verde == UP:
            self.trem_verde_pos = (
                self.trem_verde_pos[0], self.trem_verde_pos[1] - speed_verde)

    def L2(self):
        if self.direction_verde == RIGHT:
            self.trem_verde_pos = (
                self.trem_verde_pos[0] + speed_verde, self.trem_verde_pos[1])
    ...
    def L_conflito(self):
        if self.direction_roxo == UP:
            ...
            # print("executou roxo")
            self.trem_roxo_pos = (
                self.trem_roxo_pos[0], self.trem_roxo_pos[1] - speed_roxo)

    def Lara_conflito(self):
        if self.direction_laranja == UP:
            self.trem_laranja_pos = (
                self.trem_laranja_pos[0], self.trem_laranja_pos[1] - speed_laranja)
    ...
    def L5(self): 
      if self.direction_roxo == DOWN:
        self.trem_roxo_pos = (self.trem_roxo_pos[0], self.trem_roxo_pos[1] + speed_roxo)
        # if self.direction_laranja == UP:
    ...
    def L6(self):
        if self.direction_roxo == LEFT:
            self.trem_roxo_pos = (
                self.trem_roxo_pos[0] - speed_roxo, self.trem_roxo_pos[1])
        # if self.direction_azul == RIGHT:
        #     self.trem_azul_pos = (self.trem_azul_pos[0] + 10, self.trem_azul_pos[1])
    ...
    def L8(self):
        if self.direction_laranja == RIGHT:
            self.trem_laranja_pos = (
                self.trem_laranja_pos[0] + speed_laranja, self.trem_laranja_pos[1])
    ...
    def L11(self):
        if self.direction_azul == UP:
            self.trem_azul_pos = (
                self.trem_azul_pos[0], self.trem_azul_pos[1] - 10)
    ...
    def L13(self):
        if self.direction_azul == LEFT:
            self.trem_azul_pos = (
                self.trem_azul_pos[0] - 10, self.trem_azul_pos[1])
    ...
    def trem_verde_(self):
        ...
        self.L4()
        # else:
        #   self.trem_verde_pos = (self.trem_verde_pos[0], self.trem_verde_pos[1])
          # mutex2.release()
        ...
        # elif self.direction_azul == RIGHT and self.direction_verde == LEFT:
        #   self.trem_verde_pos = (self.trem_verde_pos[0], self.trem_verde_pos[1])
        else:
            self.L_conflito()
            self.L3()
    ...
    def trem_roxo_(self):
        ...
        # mutex3.acquire()
        # mutex4.release()
        # if self.trem_azul_pos == RIGHT:
        #   self.trem_roxo_pos = (
        #       self.trem_roxo_pos[0], self.trem_roxo_pos[1])
        # else:
        # if self.direction_azul != RIGHT and self.direction_verde != LEFT and self.direction_laranja != LEFT:
        # self.L6()
          # control_threads.acquire()
        self.L7()
        # mutex2.acquire(True)
        ...
        # if self.direction_azul != RIGHT:
        self.L6()
        # elif self.direction_azul == RIGHT and self.direction_roxo == LEFT:
        #   self.trem_roxo_pos = (
        #       self.trem_roxo_pos[0], self.trem_roxo_pos[1])
        #   self.L14()
        ...
        if self.direction_roxo == DOWN and self.direction_laranja == UP:
            ...
            self.L5()
            self.trem_laranja_pos = (
                self.trem_laranja_pos[0], self.trem_laranja_pos[1])
        # elif self.direction_azul == RIGHT and self.direction_roxo == LEFT:
        #   self.trem_roxo_pos = (
        #       self.trem_roxo_pos[0], self.trem_roxo_pos[1])
        else:
        ...
        # if self.direction_azul == RIGHT and self.direction_laranja == DOWN:
        # self.L6()
        # else:
        #   self.trem_verde_pos = (
        #       self.trem_verde_pos[0], self.trem_verde_pos[1])
          # mutex2.release()
    ...
    def trem_laranja_(self):
        ...
        # if self.direction_azul == RIGHT and self.direction_laranja == LEFT:
        #   self.trem_laranja_pos = (self.trem_laranja_pos[0], self.trem_laranja_pos[1])

        self.L8()
        self.L9()
        # # mutex5.acquire()
        # if self.direction_azul != RIGHT and self.direction_verde == LEFT:
    ...
    def trem_azul_(self):
        ...
        print("self.trem_azul_pos:", self.trem_azul_pos)
        print("self.direction_azul:", self.direction_azul)
        # if self.direction_azul != RIGHT:
        #   print("entrou if azul")
        #   self.L6()
        #   self.L4()
          # self.L10()
        self.L12()
        self.L13()
        self.L11()
        # if self.direction_laranja != LEFT  and (self.direction_roxo != RIGHT or self.direction_roxo != UP )  and self.direction_verde != LEFT:
        if self.direction_roxo != LEFT and self.direction_verde != DOWN and self.direction_laranja != LEFT and self.direction_laranja != UP and self.direction_verde != LEFT:
          self.L14()
        # elif :
        #   self.L14()
        # else:
        #   self.L14()
          # if self.direction_azul == RIGHT and self.direction_verde != LEFT and self.direction_verde != LEFT and self.direction_laranja != LEFT:
        #     print("entrou if azul")
        ...
        #     self.trem_roxo_pos = (self.trem_roxo_pos[0], self.trem_roxo_pos[1])
        #     self.L14()
        # elif self.direction_azul == RIGHT and self.direction_laranja == LEFT:
        #     self.trem_laranja_pos = (self.trem_laranja_pos[0], self.trem_laranja_pos[1])
        #     self.L14()
        # else:
            # self.trem_azul_pos = (self.trem_azul_pos[0], self.trem_azul_pos[1])
            # self.trem_azul_pos = (self.trem_azul_pos[0], self.trem_azul_pos[1])
            # self.L4()
            # self.L6()
            # self.L10()
